...
layout: wiki
title: Epic Cards
permalink: /teko/wiki/cards/epic/
# --- FILA 1: NAVEGACIÓN ---
...
| Icon | Description |
| :---: | :---: |
| <img src="/assets/cards/spittoon.jpg" width="50"><br>**Spittoon** | +1 discard<br>x1.3 multi<br><span style="color:#00FF1A">Action</span> |
| <img src="/assets/cards/thecollector.jpg" width="50"><br>**The collector** | +4 base per each chip without default sticker shape/color<br>16% chances of adding a random sticker to each played chip (if it still has default sticker)<br><span style="color:#00FF1A">Action</span> |
...
| <img src="/assets/cards/perfection.jpg" width="50"><br>**Perfection** | Chips with number 7 scores +7 multi |
| <img src="/assets/cards/potentiallysuspiciousman.jpg" width="50"><br>**Potentially suspicious man** | Generates a common/rare card to his left after winning each round<br><span style="color:#FFE500">Indestructible</span> |
...
| :---: | :---: | :---: |
| <img src="/assets/cards/cheers.jpg" width="50"><br>**Cheers** | Creates a consumable when you score a penta combo | Use 20 consumables and do 20 pentas |
| <img src="/assets/cards/alchemy.jpg" width="50"><br>**Alchemy** | Generate a consumable every time you sell a card | Sell 10 cards |
| <img src="/assets/cards/trixi.jpg" width="50"><br>**Trixi** | x1.8 multi<br><span style="color:#00FF1A">Action</span> | Score your first trixi special combo |
| <img src="/assets/cards/mortgage.jpg" width="50"><br>**Mortgage** | Full mansion don't score but upgrades 1 combo (max 3 per round) | Score a trihostel |
| <img src="/assets/cards/olga.jpg" width="50"><br>**Olga** | +$2 every time you spend mana | Defeat olga 5 times |
| <img src="/assets/cards/lankvian.jpg" width="50"><br>**Lankvian** | Raises the number of the first chip played (if it's at 10, it will go to 1)<br>If lankvian is to the right of all cards, the effect can combine with retriggers and raise the number more than once, otherwise it will only raise the number on the chip once<br>This cannot interact with Numberless or Ultranumber<br><span style="color:#FF00D7">Unique</span> | Defeat lankvian 5 times |
| <img src="/assets/cards/idleoverlord.jpg" width="50"><br>**Idle overlord** | Generates 2 random mods every time you won a round<br>+1/2/4 multi (depends on rarity) for each mod equipped on all cards<br><span style="color:#00FF1A">Action</span> | Open 10 mod packs |
