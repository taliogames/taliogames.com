...
| <img src="/assets/cards/hammer.jpg" width="50"><br>**Hammer** | +3 multi everytime you destroy a chip |
| <img src="/assets/cards/perfection.jpg" width="50"><br>**Perfection** | Chips with number 7 scores +7 multi |
| <img src="/assets/cards/potentiallysuspiciousman.jpg" width="50"><br>**Potentially suspicious man** | Generates a common/rare card to his left after win every round |
| <img src="/assets/cards/extremedopamine.jpg" width="50"><br>**Extreme dopamine** | +1 multi per each $1 |
...
| :---: | :---: | :---: |
| <img src="/assets/cards/cheers.jpg" width="50"><br>**Cheers** | Creates a consumable when scores a penta combo | Use 20 consumables and do 20 pentas |
| <img src="/assets/cards/alchemy.jpg" width="50"><br>**Alchemy** | Generate a consumable everytime you sell a card | Sell 10 cards |
| <img src="/assets/cards/trixi.jpg" width="50"><br>**Trixi** | x1.8 multi | Score your first trixi special combo |
...
| <img src="/assets/cards/lankvian.jpg" width="50"><br>**Lankvian** | Raises the number of the first chip played (if it's at 10, it will go to 1)<br>If lankvian is to the right of all cards, the effect can combine with retriggers and raise the number more than once, otherwise it will only raise the number on the chip once | Defeat lankvian 5 times |
| <img src="/assets/cards/idleoverlord.jpg" width="50"><br>**Idle overlord** | Generates 2 random mods everytime you won a round<br>+1/2/4 multi (depends on rarity) for each mod equipped on all cards | Open 10 mod packs |
| <img src="/assets/cards/mikello.jpg" width="50"><br>**Mikello** | Each play kills a chip from your hand<br>+5 base per each chip deleted | Defeat mikello 5 times |
